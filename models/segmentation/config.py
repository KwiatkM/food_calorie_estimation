...
test_dataloader = dict(
    ...
    dataset=dict(
        data_prefix=dict(
            img_path='test/img', seg_map_path='test/masks_machine'),
        data_root='data/foodseg103',
        pipeline=[
...
train_dataloader = dict(
    ...
    dataset=dict(
        data_prefix=dict(
            img_path='train/img', seg_map_path='train/masks_machine'),
        data_root='data/foodseg103',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='LoadAnnotations'),
...
work_dir = './work_dirs/swin-base-patch4-window7-in1k-pre_upernet_8xb2-160k_foodseg103-512x512'
